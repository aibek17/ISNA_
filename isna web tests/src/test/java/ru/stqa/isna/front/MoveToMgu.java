...
public class MoveToMgu {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    driver.findElement(By.linkText("АРМ ОГД")).click();
    driver.findElement(By.linkText("Журнал оперативного мониторинга статусов оказания услугперейти")).click();
    driver.findElement(By.linkText("Мониторинг обработки документовперейти")).click();
  }
