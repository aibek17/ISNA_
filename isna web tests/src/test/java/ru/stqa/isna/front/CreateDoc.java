...
// 830327473449
    ...
    driver.findElement(By.name("iinBin")).sendKeys("8");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("3");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("0");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("3");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("2");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("7");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("4");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("7");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("3");
    ...
    driver.findElement(By.name("iinBin")).sendKeys("4");
    driver.findElement(By.name("iinBin")).click();
    driver.findElement(By.name("iinBin")).sendKeys("9");
